...
const SellerOnboarding = () => {
  ...
  useEffect(() => {
    const checkExistingSession = async () => {
      // Session check would go here - mock implementation
      // For now just check auth context when available
    };
      ...
      <div className="min-h-screen bg-background flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center p-4">
          ...
          >
            ...
            >
              Your seller account is ready. Start uploading your products and
              reach thousands of healthcare professionals across Nigeria.
            </motion.p>
          ...
          >
            ...
            <p className="text-muted-foreground">
              {isLogin
                ...
                : "Join our network of trusted medical suppliers"}
            </p>
          </motion.div>
          ...
          >
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-muted-foreground">
                {isLogin
                  ? "Sign In"
                  : `Step ${currentStep.step} of ${totalStepCount}`}
              </span>
            ...
            {!isLogin && (
              <div className="flex justify-between mt-2 text-xs text-muted-foreground">
                <span
                  className={
                    currentStep.step >= 1 ? "text-doju-lime font-medium" : ""
                  }
                >
                  Business
                </span>
                <span
                  className={
                    currentStep.step >= 2 ? "text-doju-lime font-medium" : ""
                  }
                >
                  Contact
                </span>
                <span
                  className={
                    currentStep.step >= 3 ? "text-doju-lime font-medium" : ""
                  }
                >
                  Security
                </span>

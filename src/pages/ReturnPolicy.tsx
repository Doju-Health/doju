...
const ReturnPolicy = () => {
  const policies = [
    ...
    },
    {
      ...
      description:
        "Items must be returned in original, unopened packaging when possible.",
    },
    {
      icon: RefreshCw,
            ...
            <div className="prose prose-neutral max-w-none space-y-6">
              <section>
                ...
                <ol className="list-decimal list-inside text-muted-foreground space-y-2">
                  <li>
                    Log into your Doju account and go to your order history
                  </li>
                  <li>
                    Select the item you wish to return and click "Request
                    Return"
                  </li>
                  <li>Choose your reason for return and submit the request</li>
                  <li>Print the prepaid shipping label (if applicable)</li>
                  <li>
                    Package the item securely and drop off at the designated
                    carrier
                  </li>
                </ol>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  ...
                  returned once opened, including consumables, personal
                  protective equipment, and items marked as final sale.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  ...
                  48 hours. We'll arrange a replacement or full refund at no
                  cost to you.
                </p>
              </section>

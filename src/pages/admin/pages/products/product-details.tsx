...
import { useApproveProduct } from "@/pages/admin/api/use-approve-product";
import { useDeleteProduct } from "@/pages/admin/api/use-delete-product";
...
const AdminProductDetails = () => {
  ...
  const productQuery = useGetAProduct(id!);
  ...
  return (
    <QueryWrapper currentQuery={productQuery}>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                ...
                <strong>{product?.name}</strong>? This will make the product
        ...
        <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
          <AlertDialogContent>
            ...
            <div className="px-1 py-2">
              ...
              >
                <option value="soft">
                  Soft delete — hide from marketplace
                </option>
